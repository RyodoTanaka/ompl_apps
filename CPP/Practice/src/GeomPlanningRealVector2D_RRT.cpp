...
void planWithSimpleSetup(void)
{
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningRealVector2D_RRT", "path0"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RRT", "path"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RRT", "vertics"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RRT", "edges"); 

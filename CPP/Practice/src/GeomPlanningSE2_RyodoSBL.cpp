...
void planWithSimpleSetup(void)
{
  ...
  ob::PlannerPtr planner(new og::RyodoSBL(ss.getSpaceInformation()));
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningSE2_RyodoSBL", "path0"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoSBL", "path"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoSBL", "vertics"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoSBL", "edges"); 

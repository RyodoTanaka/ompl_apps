...
void planWithSimpleSetup(void)
{
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningSE2_RyodoRRT", "path0"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoRRT", "path"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoRRT", "vertics"); 
    ...
    filename = setFilename("GeomPlanningSE2_RyodoRRT", "edges"); 

...
void planWithSimpleSetup(void)
{
  ...
  ob::PlannerPtr planner(new og::RyodoRRT(ss.getSpaceInformation()));
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningRealVector2D_RyodoRRT", "path0"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RyodoRRT", "path"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RyodoRRT", "vertics"); 
    ...
    filename = setFilename("GeomPlanningRealVector2D_RyodoRRT", "edges"); 

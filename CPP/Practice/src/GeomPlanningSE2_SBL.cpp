...
void planWithSimpleSetup(void)
{
  ...
  ob::PlannerPtr planner(new og::SBL(ss.getSpaceInformation()));
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningSE2_SBL", "path0"); 
    ...
    filename = setFilename("GeomPlanningSE2_SBL", "path"); 
    ...
    filename = setFilename("GeomPlanningSE2_SBL", "vertics"); 
    ...
    filename = setFilename("GeomPlanningSE2_SBL", "edges"); 

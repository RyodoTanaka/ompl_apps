...
void planWithSimpleSetup(void)
{
  ...
  if (solved)
  {
    ...
    std::string filename;
    filename = setFilename("GeomPlanningSE2_Info", "path0"); 
    ...
    filename = setFilename("GeomPlanningSE2_Info", "path"); 
    ...
    filename = setFilename("GeomPlanningSE2_Info", "vertics"); 
    ...
    filename = setFilename("GeomPlanningSE2_Info", "edges"); 
